...
## Corpus Check
- 73 files · ~189,854 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1956 nodes · 3794 edges · 138 communities (121 shown, 17 thin omitted)
...
- `renderPendenciasTypeFilters()` --indirect_call--> `pendingTypeLabel()`  [INFERRED]
  app.js → app.js  _Bridges community 106 → community 30_
- `renderResults()` --indirect_call--> `resultTemplate()`  [INFERRED]
  app.js → app.js  _Bridges community 126 → community 99_
- `renderTests()` --indirect_call--> `testTemplate()`  [INFERRED]
  app.js → app.js  _Bridges community 30 → community 138_
- `renderGestorJobCandidatesTable()` --indirect_call--> `gestorCandidateRow()`  [INFERRED]
  app.js → app.js  _Bridges community 72 → community 33_
...
Cohesion: 0.27
Nodes (10): canGestorApproveRequests(), filterGestorHiringRequests(), formatBRDate(), formatGestorPendDue(), hiringRequestDueMeta(), lastHiringMovement(), myGestorApprovalRequests(), myGestorHiringRequests() (+2 more)
...
### Community 5 - "renderPipeline"
Cohesion: 0.12
Nodes (23): addCandidateComment(), applyPipelineFiltersFromDialog(), candidateCardTemplate(), candidateComments(), cardPanelMarkup(), clearPipelineAdvancedFilters(), clearPipelineSelection(), clearSinglePipelineFilter() (+15 more)
...
### Community 7 - "renderCandidateHome"
Cohesion: 0.16
Nodes (24): candidateActionMapMarkup(), candidateNextActionsMarkup(), candidatePortalHasActiveOffer(), findInterviewConflicts(), formatCandidateInterviewDate(), getCandidateFitItems(), getCandidateInterviewItems(), getCandidatePortalActionMap() (+16 more)

### Community 8 - "normalize"
Cohesion: 0.18
Nodes (19): candidateApplicationMatchesFilter(), candidateApplicationTimeline(), candidateAppNextSteps(), candidateAppsFilterLabel(), candidateAppStageClass(), candidateVisibleStage(), findCandidateByEmail(), findCandidateForAnalysis() (+11 more)
...
### Community 12 - "submitInterview"
Cohesion: 0.16
Nodes (22): closeInterviewConductReview(), confirmCandidateInterview(), confirmInterviewRequest(), ensureInterviewMeetLink(), finalizeConductInterview(), formatInterviewWhen(), interviewActivity(), meetFromLink() (+14 more)
...
Cohesion: 0.12
Nodes (23): escapeHtml(), fillTalentFilterOptions(), getCatalogTestsByType(), getHiringApprovalFlow(), getTestGabaritoStats(), openApplyTestForCandidate(), openPipelineActionDialog(), openTestPreview() (+15 more)
...
### Community 33 - "renderGestorPortal"
Cohesion: 0.24
Nodes (13): closeGestorRequestForm(), gestorFunnelCounts(), gestorFunnelStageId(), gestorJobCandidates(), jobDaysOpen(), jobSlaLabel(), jobSlaLabelPt(), renderGestorJobCandidatesTable() (+5 more)
...
### Community 45 - "getFitModelById"
Cohesion: 0.13
Nodes (21): addFitPillar(), computeFitAdherence(), createFitAssignment(), defaultFitModelForJob(), duplicateFitQuestion(), ensureJobInstrumentsForCandidate(), fitOptionScore(), fitQuestionMaxScore() (+13 more)

### Community 46 - "openScoreEvaluationDetail"
Cohesion: 0.11
Nodes (38): activeScorecardForVacancy(), autoScoreForCriterion(), computeOverallScore(), defaultScorecardCriteria(), deriveEvaluationStatus(), duplicateScorecard(), emptyScoreRows(), ensureScoreEvaluation() (+30 more)
...
Cohesion: 0.13
Nodes (24): applyTalentEdit(), clearTalentAdvancedFilters(), closeTalentDrawer(), closeTalentEditDialog(), formatTalentMoney(), getActiveTalentFilters(), getFilteredTalents(), matchBlockMarkup() (+16 more)
...
### Community 58 - "commitGestorRequestDecision"
Cohesion: 0.29
...
Cohesion: 0.15
Nodes (29): addConductPoint(), autosaveConductDraft(), backToConductWorkspace(), clearConductAutosaveTimer(), closeInterviewConduct(), conductProgress(), defaultConductNextStage(), ensureConductDraft() (+21 more)

### Community 70 - "runPendenciaAction"
Cohesion: 0.16
Nodes (16): contactPreviewText(), dossierTabForPendingType(), focusPendingTarget(), openContactDialog(), openPendingContact(), openPendingInterviewResult(), openPendingInterviewSheet(), openPendingJobApproval() (+8 more)
...
### Community 72 - "computeMatch"
Cohesion: 0.12
Nodes (25): assignmentsForCandidate(), candidateHasPendingGestorAnalysis(), computeMatch(), daysInStage(), emptyProcessValue(), findAnalysisForCandidate(), fitAssignmentsForCandidate(), gestorAnalysisToolbarIcon() (+17 more)
...
### Community 77 - "openFitAssignmentDetail"
Cohesion: 0.19
Nodes (15): closeFitMoreActions(), findReusableFitAssignment(), fitAssignmentActionsFor(), fitModelTitle(), formatAssignmentDate(), getFilteredFitAssignments(), getFitAssignmentById(), openFitApplyDialog() (+7 more)

### Community 78 - "setCandidatePortalView"
Cohesion: 0.20
Nodes (14): candidatePortalHasActivePreAdmission(), candidateVacancyPickerCard(), closeOverlayDialogs(), closeTopbarPopovers(), getPortalPreAdmission(), getPortalPreAdmissionListItems(), handleCandidateNextAction(), openCandidatePortal() (+6 more)
...
### Community 95 - "getSheetTemplateById"
Cohesion: 0.11
...
Cohesion: 0.13
Nodes (28): candidateAvatars(), closeJobMoreActions(), convertPreAdmissionToEmployee(), duplicateJob(), ensureJobDefaults(), getFilteredJobs(), jobActionsForStatus(), jobCanHire() (+20 more)
...
### Community 99 - "dismissCandidate"
Cohesion: 0.25
Nodes (9): dismissCandidate(), getFilteredResults(), hideCandidate(), openDismissDialog(), removeCandidateFromPipeline(), renderResults(), resultCounts(), selectResultTab() (+1 more)
...
### Community 106 - "renderPendenciasPage"
Cohesion: 0.05
Nodes (69): applyGestorCandidateDecision(), applyOfferFormValues(), applyPipelineBulkStage(), archiveProposalVersion(), buildCandidateTimeline(), buildPendencies(), closeGestorCandidateDecisionDialog(), commitGestorCandidateDecision() (+61 more)

### Community 107 - "fillGestorRequestForm"
Cohesion: 0.21
...
### Community 111 - "submitCandidateApplication"
Cohesion: 0.14
Nodes (25): candidateJobAvailability(), candidateJobDatePanel(), candidateMetaGrid(), formatPublicDate(), getActiveCandidateApplyResumeName(), getCandidateApplyJobs(), getCandidateBulkApplyJobs(), getCandidateHomeMatchAverage() (+17 more)

### Community 112 - "showToast"
Cohesion: 0.14
Nodes (26): blankInterviewRequest(), cancelInterviewRequest(), collectGestorIrSlots(), findOpenInterviewRequest(), interviewRequestIsOpen(), myGestorJobs(), openCandidateResume(), openFromShareHash() (+18 more)
...
### Community 115 - "openMoveStageDialog"
Cohesion: 0.40
...
### Community 117 - "openRhHiringRequestDecision"
Cohesion: 0.83
...
### Community 125 - "renderCandidateDetails"
Cohesion: 0.26
Nodes (12): applyCatalogTestToCandidate(), confirmPipelineAction(), openCandidate(), openManagerDialog(), registerCandidateOperationalEvent(), renderCandidateDetails(), resolveCandidateDossierTab(), runPipelineCandidateAction() (+4 more)

### Community 126 - "initials"
Cohesion: 0.29
Nodes (8): fillCandidateProfileForm(), formatMoney(), initials(), openCompanyForm(), renderCandidateSkillPicker(), renderCompanyLogoPreview(), resultTemplate(), updateCandidateProfileCompletion()

### Community 127 - "goToPage"
Cohesion: 0.16
Nodes (15): approveCandidateToTalentBank(), blockCandidate(), fillNewJobFromHiringRequest(), goToPage(), handleGoTarget(), inviteTalentToJob(), openBlockDialog(), openNewJobFromHiringRequest() (+7 more)

### Community 137 - "persistCandidateTakingProgress"
Cohesion: 0.40
...
### Community 138 - "syncTestsHubTab"
Cohesion: 0.67
Nodes (3): renderTests(), setTestsHubTab(), syncTestsHubTab()

## Knowledge Gaps
- **891 isolated node(s):** `jobs`, `candidates`, `candidateSkillDefaults`, `candidateStageEnteredDefaults`, `candidateConsentDefaults` (+886 more)
...
- **Why does `showToast()` connect `showToast` to `app.js`, `persistCandidateTakingProgress`, `submitInterview`, `escapeHtml`, `renderAnalytics`, `getFitModelById`, `openScoreEvaluationDetail`, `renderTalents`, `openCandidateTestDetail`, `commitGestorRequestDecision`, `runPendenciaAction`, `showPage`, `openInterviewEditor`, `openFitAssignmentDetail`, `setCandidatePortalView`, `renderFitCulturalPage`, `renderPreAdmissions`, `saveGestorRequestDraft`, `getSheetTemplateById`, `openJobDetails`, `dismissCandidate`, `renderPendenciasPage`, `fillGestorRequestForm`, `submitCandidateApplication`, `openRhHiringRequestDecision`, `renderCandidateDetails`, `goToPage`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `escapeHtml()` connect `escapeHtml` to `app.js`, `fillInterviewCandidateOptions`, `openGestorCandidateDecisionDialog`, `formatBRDate`, `renderNewJobStages`, `renderPipeline`, `dayKey`, `renderCandidateHome`, `normalize`, `persistCandidateTakingProgress`, `submitInterview`, `renderGestorPortal`, `renderAnalytics`, `openConductHistory`, `getFitModelById`, `openScoreEvaluationDetail`, `renderTalents`, `openCandidateTestDetail`, `ensureConductDraft`, `computeMatch`, `openInterviewEditor`, `openFitAssignmentDetail`, `setCandidatePortalView`, `renderFitCulturalPage`, `renderPreAdmissions`, `getSheetTemplateById`, `openJobDetails`, `dismissCandidate`, `buildGestorPendencies`, `renderPendenciasPage`, `fillGestorRequestForm`, `submitCandidateApplication`, `showToast`, `openMoveStageDialog`, `openRhHiringRequestDecision`, `renderCandidateHeaderTags`, `renderCandidateDetails`, `initials`, `goToPage`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
