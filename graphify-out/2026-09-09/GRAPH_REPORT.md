# Graph Report - Prototipação Vagas  (2026-09-09)

## Corpus Check
- 41 files · ~135,437 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1366 nodes · 2878 edges · 79 communities (76 shown, 3 thin omitted)
...
1. `escapeHtml()` - 114 edges
2. `showToast()` - 75 edges
3. `normalize()` - 59 edges
4. `runPipelineCandidateAction()` - 29 edges
5. `renderCandidateDetails()` - 28 edges
6. `renderPipeline()` - 27 edges
7. `goToPage()` - 27 edges
8. `formatBRDate()` - 25 edges
9. `setCandidatePortalView()` - 25 edges
10. `showPage()` - 24 edges

## Surprising Connections (you probably didn't know these)
- `renderJobs()` --indirect_call--> `jobTemplate()`  [INFERRED]
  app.js → app.js  _Bridges community 30 → community 74_
- `renderResults()` --indirect_call--> `resultTemplate()`  [INFERRED]
  app.js → app.js  _Bridges community 58 → community 53_
- `renderAgenda()` --indirect_call--> `interviewTemplate()`  [INFERRED]
  app.js → app.js  _Bridges community 49 → community 6_
- `renderGestorJobCandidatesTable()` --indirect_call--> `gestorCandidateRow()`  [INFERRED]
  app.js → app.js  _Bridges community 66 → community 8_
- `buildCandidateTimeline()` --calls--> `testTypeLabel()`  [EXTRACTED]
  app.js → app.js  _Bridges community 72 → community 70_
...
### Community 0 - "app.js"
Cohesion: 0.01
Nodes (169): activityList, analyticsDrillState, analyticsFilters, APPROVAL_PERSONAS, approvalPersona, appShell, benefitOptions, benefitsCatalog (+161 more)
...
Cohesion: 0.07
Nodes (54): candidateApplicationMatchesFilter(), candidateApplicationTimeline(), candidateAppNextSteps(), candidateAppsFilterLabel(), candidateAppStageClass(), candidateJobAvailability(), candidateJobDatePanel(), candidateMetaGrid() (+46 more)
...
Cohesion: 0.13
Nodes (19): contactPreviewText(), dossierTabForPendingType(), focusPendingTarget(), moveCandidate(), openContactDialog(), openDismissDialog(), openMoveStageDialog(), openPendingContact() (+11 more)

### Community 6 - "dayKey"
Cohesion: 0.15
Nodes (21): calendarEventsForMonth(), dayKey(), fillAgendaVacancyFilter(), formatInterviewGroupLabel(), fullCalendarEventClass(), getAgendaInterviews(), getFilteredInterviews(), groupInterviewsByDay() (+13 more)

### Community 7 - "showToast"
Cohesion: 0.19
Nodes (20): addCandidateComment(), applyPipelineBulkStage(), approveCandidateToTalentBank(), confirmCandidateInterview(), confirmMoveStage(), ensureCandidateComments(), finalizeConductInterview(), interviewActivity() (+12 more)

### Community 8 - "renderGestorPortal"
Cohesion: 0.09
Nodes (38): closeGestorJobView(), closeGestorRequestForm(), closeSidebar(), collectGestorOverviewMetrics(), gestorFunnelCounts(), gestorHashFromState(), gestorJobCandidates(), gestorNavKeyFromState() (+30 more)
...
Cohesion: 0.08
Nodes (44): addPreAdmissionPendency(), candidateAvatars(), closeJobMoreActions(), convertPreAdmissionToEmployee(), defaultPreAdmissionChecklist(), duplicateJob(), ensureCandidateDocuments(), ensureJobDefaults() (+36 more)
...
### Community 33 - "renderPipeline"
Cohesion: 0.17
Nodes (20): candidateCardTemplate(), candidateComments(), cardPanelMarkup(), clearPipelineSelection(), computeMatch(), daysInStage(), getCandidateTestScore(), getFilteredCandidates() (+12 more)

### Community 34 - "openCandidateTestDetail"
Cohesion: 0.19
Nodes (22): assignmentActionsFor(), assignmentCatalog(), assignmentsForCandidate(), assignmentStatusClass(), assignmentTitle(), closeAssignmentMoreActions(), downloadAssignmentPdf(), getAssignmentById() (+14 more)
...
Cohesion: 0.10
Nodes (26): candidateToDrillItem(), chartRamp(), clearAnalyticsAdvancedFilters(), clearSingleAnalyticsFilter(), closeAnalyticsFiltersDialog(), countBy(), exportAnalyticsStub(), fillAnalyticsFilterOptions() (+18 more)
...
### Community 45 - "sheetTemplateCard"
Cohesion: 0.25
...
### Community 46 - "renderFitCulturalPage"
Cohesion: 0.15
Nodes (17): addFitPillar(), fitQuestionTypeLabel(), getFitPillarById(), openFitModelEditor(), openFitQuestionEditor(), removeFitPillar(), renderFitBanco(), renderFitCulturalPage() (+9 more)
...
### Community 49 - "normalize"
Cohesion: 0.16
Nodes (17): agendaEventChip(), applyTalentEdit(), closeInterviewMoreActions(), closeTalentEditDialog(), findDuplicates(), getCandidateInterviewItems(), interviewIsOverdue(), interviewTemplate() (+9 more)
...
Cohesion: 0.18
Nodes (14): applyCatalogTestToCandidate(), closeCandidateMoreActions(), confirmPipelineAction(), getCatalogTestsByType(), openApplyTestForCandidate(), openCandidate(), openManagerDialog(), openPipelineActionDialog() (+6 more)

### Community 53 - "goToPage"
Cohesion: 0.19
Nodes (13): blockCandidate(), closeOverlayDialogs(), dismissCandidate(), getFilteredResults(), goToPage(), handleGoTarget(), hideCandidate(), openBlockDialog() (+5 more)
...
### Community 58 - "formatBRDate"
Cohesion: 0.06
Nodes (49): analysisStatusMeta(), blankHiringRequest(), canGestorApproveRequests(), confirmBookingSlot(), defaultInterviewTimeEnd(), fillGestorRequestForm(), fillInterviewInterviewers(), fillInterviewSheetOptions() (+41 more)
...
### Community 63 - "submitInterview"
Cohesion: 0.20
Nodes (12): findInterviewConflicts(), formatInterviewWhen(), interviewInterval(), interviewsOverlap(), meetFromLink(), normalizeInterviewRecord(), openCandidateRescheduleDialog(), openInterviewCancelDialog() (+4 more)

### Community 64 - "getSheetTemplateById"
Cohesion: 0.09
Nodes (44): addSheetQuestion(), autosaveConductDraft(), backToConductWorkspace(), clearConductAutosaveTimer(), closeInterviewConduct(), conductProgress(), createSheetTemplate(), defaultConductNextStage() (+36 more)

### Community 65 - "renderPipelineFilters"
Cohesion: 0.25
Nodes (9): applyPipelineFiltersFromDialog(), clearPipelineAdvancedFilters(), clearSinglePipelineFilter(), closePipelineFiltersDialog(), getActivePipelineFilters(), openPipelineFiltersDialog(), renderPipelineFilterChips(), renderPipelineFilters() (+1 more)

### Community 66 - "runGestorCandidateAction"
Cohesion: 0.21
Nodes (16): candidateHasPendingGestorAnalysis(), ensureCandidateGestorNotes(), findAnalysisForCandidate(), findCandidateForAnalysis(), gestorCandidateRow(), gestorFitSummary(), gestorFunnelStageId(), gestorPendenciesSummary() (+8 more)
...
### Community 68 - "escapeHtml"
Cohesion: 0.13
Nodes (20): candidateTestKey(), createTest(), escapeHtml(), fillCandidateProfileForm(), fillTalentFilterOptions(), getTestGabaritoStats(), openTestEditor(), openTestPreview() (+12 more)

### Community 69 - "renderTalents"
Cohesion: 0.14
Nodes (18): clearTalentAdvancedFilters(), closeTalentDrawer(), formatTalentMoney(), getActiveTalentFilters(), getFilteredTalents(), matchBlockMarkup(), openTalentDrawer(), openTalentEditDialog() (+10 more)

### Community 70 - "buildCandidateTimeline"
Cohesion: 0.28
Nodes (9): buildCandidateTimeline(), ensureCandidateTimeline(), fitAssignmentsForCandidate(), formatTimelineAt(), renderCandidateTimeline(), syncCandidateFitScore(), timelineEventCardMarkup(), timelineInterviewType() (+1 more)
...
### Community 72 - "testTypeLabel"
Cohesion: 0.47
Nodes (6): findCandidateByEmail(), getCandidateFitItems(), getCandidateTestItems(), renderCandidateTests(), testTypeLabel(), updateCandidateSidebarUser()

### Community 73 - "proposalSalary"
Cohesion: 0.11
Nodes (35): archiveProposalVersion(), buildPendencies(), countPendenciesByBucket(), createEmptyProposal(), ensureCandidateProposal(), ensureProposalShape(), findPendingItemById(), formatOfferMoney() (+27 more)

### Community 74 - "submitCandidateApplication"
Cohesion: 0.50
Nodes (4): getFilteredJobs(), openCandidateApplicationSuccess(), renderJobs(), submitCandidateApplication()

### Community 77 - "openScoreEvaluationDetail"
Cohesion: 0.11
...
### Community 81 - "saveGestorRequestDraft"
Cohesion: 0.67
Nodes (3): applyFormToHiringRequest(), readGestorRequestFormValues(), saveGestorRequestDraft()

## Knowledge Gaps
- **550 isolated node(s):** `jobs`, `candidates`, `candidateSkillDefaults`, `candidateStageEnteredDefaults`, `candidateConsentDefaults` (+545 more)
...
- **Why does `escapeHtml()` connect `escapeHtml` to `app.js`, `setCandidatePortalView`, `runPendenciaAction`, `dayKey`, `showToast`, `renderGestorPortal`, `openNewJobPage`, `convertPreAdmissionToEmployee`, `renderPipeline`, `openCandidateTestDetail`, `renderAnalytics`, `openConductHistory`, `sheetTemplateCard`, `renderFitCulturalPage`, `normalize`, `runPipelineCandidateAction`, `formatBRDate`, `submitInterview`, `getSheetTemplateById`, `renderPipelineFilters`, `runGestorCandidateAction`, `renderTalents`, `buildCandidateTimeline`, `testTypeLabel`, `proposalSalary`, `openScoreEvaluationDetail`, `openFitAssignmentDetail`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `showToast()` connect `showToast` to `app.js`, `setCandidatePortalView`, `runPendenciaAction`, `renderGestorPortal`, `convertPreAdmissionToEmployee`, `renderPipeline`, `openCandidateTestDetail`, `renderAnalytics`, `renderFitCulturalPage`, `normalize`, `runPipelineCandidateAction`, `goToPage`, `formatBRDate`, `submitInterview`, `getSheetTemplateById`, `runGestorCandidateAction`, `renderTalents`, `proposalSalary`, `submitCandidateApplication`, `openScoreEvaluationDetail`, `openFitAssignmentDetail`, `saveGestorRequestDraft`?**
