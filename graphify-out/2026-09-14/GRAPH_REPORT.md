# Graph Report - Prototipação Vagas  (2026-09-14)

## Corpus Check
- 50 files · ~172,673 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1671 nodes · 3521 edges · 106 communities (96 shown, 10 thin omitted)
...
- `renderTests()` --indirect_call--> `testTemplate()`  [INFERRED]
  app.js → app.js  _Bridges community 30 → community 95_
...
- `saveCandidateTestDraft()` --calls--> `getAssignmentById()`  [EXTRACTED]
  app.js → app.js  _Bridges community 53 → community 73_
...
Cohesion: 0.21
Nodes (15): applyHiringRequestDecision(), closeGestorRequestForm(), closeHiringRequestDecisionDialog(), formatOfferMoneyRange(), jobDaysOpen(), jobSlaLabel(), jobSlaLabelPt(), openGestorRequestForm() (+7 more)
...
### Community 5 - "openNewJobFromHiringRequest"
Cohesion: 0.40
Nodes (6): fillNewJobFromHiringRequest(), openNewJobFromHiringRequest(), openNewJobPage(), renderNewJobCatalogs(), renderNewJobStages(), syncNewJobStagesValue()

### Community 6 - "dayKey"
Cohesion: 0.07
Nodes (42): agendaEventChip(), applyInterviewCandidateSelection(), calendarEventsForMonth(), countGestorInterviewBuckets(), dayKey(), defaultInterviewTimeEnd(), fillAgendaVacancyFilter(), fillInterviewCandidateOptions() (+34 more)

### Community 7 - "openFitAssignmentDetail"
Cohesion: 0.14
Nodes (23): closeFitMoreActions(), computeFitAdherence(), defaultFitModelForJob(), duplicateFitQuestion(), findReusableFitAssignment(), fitAssignmentActionsFor(), fitModelTitle(), fitOptionScore() (+15 more)

### Community 8 - "proposalSalary"
Cohesion: 0.08
Nodes (45): applyOfferFormValues(), applyPipelineBulkStage(), archiveProposalVersion(), buildCandidateTimeline(), candidateVacancyPickerCard(), confirmMoveStage(), createEmptyProposal(), defaultPreAdmissionChecklist() (+37 more)
...
### Community 12 - "goToPage"
Cohesion: 0.13
Nodes (19): closeGestorJobView(), closeSidebar(), createTest(), gestorHashFromState(), gestorNavKeyFromState(), goToPage(), handleGoTarget(), openTestEditor() (+11 more)
...
Cohesion: 0.13
Nodes (22): escapeHtml(), fillTalentFilterOptions(), getCatalogTestsByType(), getHiringApprovalFlow(), getTestGabaritoStats(), openApplyTestForCandidate(), openPipelineActionDialog(), openTestPreview() (+14 more)
...
### Community 45 - "renderFitCulturalPage"
Cohesion: 0.28
...
Cohesion: 0.07
Nodes (57): activeScorecardForVacancy(), applyCatalogTestToCandidate(), autoScoreForCriterion(), computeOverallScore(), confirmPipelineAction(), createFitAssignment(), defaultScorecardCriteria(), deriveEvaluationStatus() (+49 more)
...
### Community 52 - "renderPipeline"
Cohesion: 0.06
Nodes (46): applyPipelineFiltersFromDialog(), applyTalentEdit(), blockCandidate(), candidateCardTemplate(), cardPanelMarkup(), clearPipelineAdvancedFilters(), clearPipelineSelection(), clearSinglePipelineFilter() (+38 more)
...
### Community 68 - "fillGestorRequestForm"
Cohesion: 0.36
...
Cohesion: 0.05
Nodes (79): addConductPoint(), applyGestorCandidateDecision(), approveCandidateToTalentBank(), autosaveConductDraft(), backToConductWorkspace(), clearConductAutosaveTimer(), closeGestorCandidateDecisionDialog(), closeInterviewConduct() (+71 more)
...
Cohesion: 0.10
Nodes (29): addCandidateComment(), assignmentsForCandidate(), candidateComments(), candidateHasPendingGestorAnalysis(), emptyProcessValue(), ensureCandidateComments(), findAnalysisForCandidate(), gestorAnalysisToolbarIcon() (+21 more)

### Community 73 - "persistCandidateTakingProgress"
Cohesion: 0.40
...
Cohesion: 0.16
Nodes (24): candidateAvatars(), closeJobMoreActions(), convertPreAdmissionToEmployee(), duplicateJob(), ensureJobDefaults(), getFilteredJobs(), hideCandidate(), jobCanHire() (+16 more)

### Community 78 - "getSheetTemplateById"
Cohesion: 0.11
Nodes (29): addSheetQuestion(), closeSheetMoreMenus(), createSheetTemplate(), deleteSheetTemplate(), duplicateSheetQuestion(), duplicateSheetTemplate(), fillSheetJobsChecklist(), formatSheetDate() (+21 more)

### Community 79 - "renderResults"
Cohesion: 0.40
Nodes (5): formatMoney(), getFilteredResults(), renderResults(), resultCounts(), resultTemplate()
...
### Community 81 - "renderCandidateDocumentsPanel"
Cohesion: 0.50
...
### Community 84 - "runPendenciaAction"
Cohesion: 0.09
Nodes (35): buildPendencies(), contactPreviewText(), countPendenciesByBucket(), dossierTabForPendingType(), findPendingItemById(), focusPendingTarget(), formatPendingDue(), getPendenciesForBucket() (+27 more)
...
### Community 95 - "syncTestsHubTab"
Cohesion: 0.67
Nodes (3): renderTests(), setTestsHubTab(), syncTestsHubTab()

### Community 96 - "normalize"
Cohesion: 0.05
Nodes (86): candidateActionMapMarkup(), candidateApplicationMatchesFilter(), candidateApplicationTimeline(), candidateAppNextSteps(), candidateAppsFilterLabel(), candidateAppStageClass(), candidateJobAvailability(), candidateJobDatePanel() (+78 more)
...
Cohesion: 0.10
Nodes (27): buildGestorPendencies(), collectGestorOverviewMetrics(), countGestorPendencies(), formatGestorPendDueLabel(), gestorPendenciesByBucket(), gestorPendingActionLabel(), gestorPendingPriority(), gestorPendingPriorityLabel() (+19 more)

### Community 107 - "closeCandidateMoreActions"
Cohesion: 0.40
Nodes (6): closeCandidateMoreActions(), closeGestorAnalysisMoreMenu(), placeCandidateMoreMenu(), resetCandidateMoreMenuPlacement(), toggleCandidateMoreActions(), toggleGestorAnalysisMoreMenu()

### Community 115 - "formatBRDate"
Cohesion: 0.18
Nodes (15): analysisStatusMeta(), canGestorApproveRequests(), confirmBookingSlot(), filterGestorHiringRequests(), formatBRDate(), formatGestorPendDue(), hiringRequestDueMeta(), hiringRequestStatusClass() (+7 more)

## Knowledge Gaps
- **686 isolated node(s):** `jobs`, `candidates`, `candidateSkillDefaults`, `candidateStageEnteredDefaults`, `candidateConsentDefaults` (+681 more)
...
- **Why does `escapeHtml()` connect `escapeHtml` to `app.js`, `renderGestorPortal`, `openNewJobFromHiringRequest`, `dayKey`, `openFitAssignmentDetail`, `proposalSalary`, `renderAnalytics`, `openConductHistory`, `renderFitCulturalPage`, `renderCandidateDetails`, `renderPipeline`, `openCandidateTestDetail`, `saveFitModel`, `fillGestorRequestForm`, `showToast`, `renderGestorCandidatePanel`, `persistCandidateTakingProgress`, `renderPreAdmissions`, `openJobDetails`, `getSheetTemplateById`, `openMoveStageDialog`, `renderCandidateDocumentsPanel`, `runPendenciaAction`, `normalize`, `renderCandidateHeaderTags`, `buildGestorPendencies`, `formatBRDate`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `showToast()` connect `showToast` to `app.js`, `renderGestorPortal`, `openNewJobFromHiringRequest`, `dayKey`, `openFitAssignmentDetail`, `proposalSalary`, `goToPage`, `escapeHtml`, `renderAnalytics`, `renderFitCulturalPage`, `renderCandidateDetails`, `renderPipeline`, `openCandidateTestDetail`, `saveFitModel`, `commitGestorRequestDecision`, `fillGestorRequestForm`, `submitGestorInterviewRequest`, `renderGestorCandidatePanel`, `persistCandidateTakingProgress`, `renderPreAdmissions`, `openJobDetails`, `getSheetTemplateById`, `runPendenciaAction`, `saveGestorRequestDraft`, `normalize`, `buildGestorPendencies`, `formatBRDate`?**
